...
export default function Home({
  ...
  return (
    <>
      {/* ================= SEO ================= */}
      <Head>
        <title>3xBooks – Discover Great Reads & Connect With Bookstores Worldwide</title>
        <meta
          name="title"
          content="3xBooks – Discover Great Reads & Connect With Bookstores Worldwide"
        />
        <meta
          name="description"
          content="Explore the best books across genres and connect with local and global bookstores. Find your next great read, latest releases, and curated collections at 3xBooks."
        />
      </Head>
