...
export default function About({ authorsSSR }) {
  ...
  return (
    <>
      <Head>
        <title>About — 3XBooks</title>
        <meta name="description" content="Learn about the 3XBooks platform and mission to support bookstores and empower readers worldwide." />
      </Head>
